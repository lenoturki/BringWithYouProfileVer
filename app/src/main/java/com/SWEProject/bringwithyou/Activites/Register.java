...
public class Register extends AppCompatActivity {
        ...
        regButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if( name.isEmpty() || password.isEmpty()  || Phone.isEmpty()  || password2.isEmpty()){
                    ...
                    String  PhoneVer = Phone;
                    if((!password.isEmpty() || !Phone.isEmpty() || !password2.isEmpty())){
                        ...
                        if(!(Phone.length()==10)&& !(PhoneVer.substring(0,1).equals("05"))){
                        ...
                        User user = new User(email,name,Phone,uid, password);
    ...
    private void CreateUserAccount(final String email, final String name, String password , final String Phone) {
